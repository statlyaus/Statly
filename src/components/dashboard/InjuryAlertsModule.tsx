  ...
  if (alerts.length === 0) {
    return (
      <div className="text-center py-6">
        ...
        <p className="text-sm text-muted-foreground">No injury alerts for your players</p>
      </div>
    );
  }
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                {alert.replacements.length > 0 && (
                  <div className="mt-2">
                    <p className="text-xs font-medium text-destructive mb-1">Suggested replacements:</p>
                    <div className="space-y-1">
                      {alert.replacements.slice(0, 2).map((replacement) => (
                        <div key={replacement.id} className="text-xs text-destructive">
