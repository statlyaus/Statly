...
export default function RecentActivityModule({ activities, refreshTrigger: _refreshTrigger }: RecentActivityModuleProps) {
        ...
        return (
          <div className="w-8 h-8 bg-green-100 rounded-full flex items-center justify-center">
            <svg className="w-4 h-4 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-9a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 01-3 0m3 0H9m3 0v5" />
            </svg>
          </div>
        );
      case 'score':
      ...
      {activities.slice(0, 5).map((activity, index) => (
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <p className={`text-sm font-medium ${activity.urgent ? 'text-red-900' : 'text-slate-900'}`}>
              {activity.message}
            </p>
