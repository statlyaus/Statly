...
const MyTeamPanelDemo = () => {
  const [activeTab, setActiveTab] = useState<'overview' | 'features' | 'config' | 'code'>('overview');
            ...
            {[
              {
                ...
                description: 'Complete roster management with player statistics and team composition analytics.',
                features: ['22-player roster', 'Position tracking', 'Team statistics', 'Value calculations']
              },
              {
                icon: StarIcon,
                title: 'Captain System',
                description: 'Set captains and vice-captains with visual indicators and status tracking.',
                features: ['Captain selection', 'Vice-captain support', 'Leadership indicators', 'Status validation']
              },
              {
                icon: ChartBarIcon,
                title: 'Advanced Analytics',
                description: 'Comprehensive team statistics with position breakdowns and performance metrics.',
                features: ['Position breakdown', 'Value analytics', 'Performance tracking', 'Roster completion']
              },
              {
                icon: TrophyIcon,
                title: 'Interactive Actions',
                description: 'Full suite of team management actions with context-aware controls.',
                features: ['Player selection', 'Team optimization', 'Trade interface', 'Bench management']
              },
              {
                icon: CogIcon,
                title: 'Customizable Interface',
                description: 'Flexible configuration options for different use cases and display preferences.',
                features: ['Compact mode', 'Height control', 'Feature toggles', 'Responsive design']
              },
              {
                icon: PlayIcon,
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-base-100 rounded-xl border border-base-300 p-6">
                ...
                <div className="text-sm space-y-2">
                  <div><code className="text-primary">team</code>: Team object</div>
                  <div><code className="text-primary">players</code>: Player array</div>
                  <div><code className="text-primary">onPlayerSelect</code>: Selection callback</div>
                  <div><code className="text-primary">onTeamAction</code>: Action callback</div>
                  <div><code className="text-primary">showAdvancedFeatures</code>: Boolean</div>
                  <div><code className="text-primary">compact</code>: Boolean</div>
                  <div><code className="text-primary">sortByValue</code>: Boolean</div>
                  <div><code className="text-primary">maxHeight</code>: String</div>
                  <div><code className="text-primary">isLoading</code>: Boolean</div>
                </div>
              </div>
