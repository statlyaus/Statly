...
export default function Watchlist({ 
  ...
  const addToWatchlist = useCallback((player: DraftPlayer) => {
    const isAlreadyWatched = watchlistItems.some(item => item.playerId === player.id);
                            ...
                            <div className="flex items-start gap-3">
                              ...
                              <div className="flex-1 min-w-0">
                                <div className="flex items-center gap-2 mb-1">
                                  ...
                                  {injury && (
                                    <injury.icon className={`w-4 h-4 ${injury.color}`} title={injury.label} />
                                  )}
                                  {isBye && (
                                    <Clock className="w-4 h-4 text-orange-600" title="Bye week" />
                                  )}
                                  {isDrafted && (
