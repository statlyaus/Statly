...
import { ensureLeagueDraftSetupConverged } from './DraftSetupConvergenceService';
...
describe('ensureLeagueDraftSetupConverged', () => {
  it('creates the missing room and starts an overdue ready draft', async () => {
    ...
    expect(startDraft).toHaveBeenCalledWith({ draftId: 'draft-1' });
