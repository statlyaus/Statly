  ...
  try {
    ...
    if (prismaLeague) {
      ...
      const members = prismaLeague.members.map((member) => ({
        ...
        teamLogoPositionX: member.teamLogoPositionX ?? undefined,
        teamLogoPositionY: member.teamLogoPositionY ?? undefined,
        teamLogoZoom: member.teamLogoZoom ?? undefined,
  ...
  return [
    {
      ...
      teamLogoPositionX: 50,
      teamLogoPositionY: 50,
      teamLogoZoom: 1,
    ...
    },
    {
      ...
      teamLogoUrl: 'https://placehold.co/160x160/304d6d/ffffff.png?text=AL',
      teamLogoPositionX: 50,
      teamLogoPositionY: 50,
      teamLogoZoom: 1,
    ...
    },
    {
      ...
      teamLogoUrl: 'https://placehold.co/160x160/7c2d12/ffffff.png?text=FF',
      teamLogoPositionX: 50,
      teamLogoPositionY: 50,
      teamLogoZoom: 1,
    ...
    },
    {
      ...
      teamLogoUrl: 'https://placehold.co/160x160/166534/ffffff.png?text=GG',
      teamLogoPositionX: 50,
      teamLogoPositionY: 50,
      teamLogoZoom: 1,
