...
describe('POST /api/etl/import-rounds', () => {
  beforeEach(() => {
    ...
    publishPlayerRankingsMock.mockResolvedValue({
      ...
      scope: 'season',
      rankingSnapshots: 0,
      rankingPublishedAt: new Date('2026-05-14T00:00:00.000Z'),
      published: true,
    ...
    publishLeagueRosterSummariesMock.mockResolvedValue({
      ...
      scope: 'season',
      rosterSummaries: 0,
      rosterPublishedAt: new Date('2026-05-14T00:00:01.000Z'),
      published: true,
      degradedAdvancedStats: [],
      rostersDirty: false,
    });
      ...
      result: {
        ...
        publication: {
          ...
          rankings: {
            ...
            scope: 'season',
            rankingSnapshots: 457,
            rankingPublishedAt: '2026-05-14T00:00:00.000Z',
            published: true,
            degradedAdvancedStats: [],
          },
          rosters: {
            ...
            scope: 'season',
            rosterSummaries: 456,
            rosterPublishedAt: '2026-05-14T00:00:01.000Z',
            published: true,
            degradedAdvancedStats: [],
            rostersDirty: false,
          },
  ...
  it('does not refresh or publish read models during dry runs', async () => {
    importFootywireRoundsMock.mockResolvedValue({
      season: 2026,
      rounds: [3],
      importedMatches: 0,
      importedPlayerStats: 0,
    });
    importAdvancedFootywireRoundsMock.mockResolvedValue({
      season: 2026,
      rounds: [3],
    ...
    expect(body.result.publication).toBeNull();
    expect(body.result.audit.rematerialization).toBeNull();
  });
