...
export default function TeamAnalyticsClient() {
      ...
      <AppLayout>
        <div className="min-h-screen flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-muted-foreground">Please sign in to view your team analytics.</p>
            <div className="mt-4">
              <button
  ...
  return (
    <AppLayout>
      {isTestMode && !user && (
        <div className="bg-warning/10 border border-warning/20 rounded-lg p-4 mb-6 mx-6">
