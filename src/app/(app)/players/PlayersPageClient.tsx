...
export default function PlayersPageClient({ players }: PlayersPageClientProps): JSX.Element {
          ...
          <div className="grid gap-5 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-end">
            <div className="max-w-3xl">
              ...
              <p className="mt-3 max-w-2xl text-sm leading-6 text-[color:var(--league-text-muted)] sm:text-base">
                Search the player pool, compare core production, and move quickly from rankings into
                player profiles.
              </p>
            </div>
