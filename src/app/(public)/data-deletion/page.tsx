  ...
  return (
    <main className="max-w-3xl mx-auto px-4 py-10">
      ...
      <section className="prose prose-neutral dark:prose-invert max-w-none">
        <p>
          You can request deletion of your account and associated personal data at any time. Once
          your request is processed, your account will be permanently removed and cannot be
          restored.
        </p>
        ...
        <ol>
          ...
          <li>
            We will verify your request and confirm deletion. You will receive a confirmation email
        ...
        <ul>
          ...
          <li>
            Content or usage data linked to your identity, unless we are required to retain it by
            law.
          </li>
        </ul>
