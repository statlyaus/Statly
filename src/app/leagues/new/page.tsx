...
export default function NewLeaguePage() {
  ...
  const handleInputChange = (
    field: keyof CreateLeagueRequest,
    value: string | number | FantasyCategoryKey[]
  ) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetchFromAPI<{ data: League }>('/api/leagues', {
        method: 'POST',
        ...
        >
          <div className="text-center">
            ...
            <p className="text-lg text-gray-600">
              Set up your fantasy AFL league with custom settings
            </p>
          </div>
          ...
          <Form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <FormField label="League Type">
                  <select
                    ...
                    value={formData.type}
                    onChange={(e) =>
                      handleInputChange('type', e.target.value as 'public' | 'private')
                    }
                  >
            ...
            >
              ...
              <p className="text-gray-600 mb-4">
                Select which stats will count toward player rankings (3-8 categories recommended)
              </p>
