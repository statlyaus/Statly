      ...
      <div>
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="flex gap-3">
            <Link href="/leagues/join"><Button variant="secondary">Join League</Button></Link>
            <Link href="/leagues/new"><Button>Create New League</Button></Link>
          </div>
        </div>
        {loading ? (
                ...
                <div className="bg-white rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                  <div className="p-6">
                    ...
                    <div className="space-y-2">
                      <p className="text-sm text-gray-500">Categories: <span className="font-medium text-gray-800">{league.categories.length}</span></p>
                      <p className="text-sm text-gray-500">Status: <span className="font-medium text-gray-800 capitalize">{league.status}</span></p>
                    </div>
                  </div>
                </div>
              </Link>
          ...
          <div className="text-center py-12 border-2 border-dashed rounded-lg">
            ...
            <p className="mt-2 text-gray-500 mb-6">You have no leagues yet. Get started below.</p>
