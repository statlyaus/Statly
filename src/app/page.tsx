...
export default function HomePage(): ReactElement {
  return (
    <div className="min-h-[calc(100vh-80px)] bg-[linear-gradient(180deg,var(--league-primary)_0%,var(--league-text)_42%,var(--league-page)_42%,var(--league-surface)_100%)] text-foreground">
      ...
      <section className="border-t border-border bg-white/72">
        <div className="mx-auto max-w-6xl px-6 py-14 lg:px-10 lg:py-16">
          ...
          <div className="mt-8 grid gap-5 md:grid-cols-2">
            {secondaryProduct.map((product) => (
              <article
                key={product.title}
                className="rounded-[1.75rem] border border-border bg-white p-6 shadow-[0_22px_60px_-44px_rgba(15,23,42,0.28)]"
              >
