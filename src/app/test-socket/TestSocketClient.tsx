...
export default function TestSocketClient() {
    ...
    <AppLayout>
      <div className="p-8">
        ...
        <div className="mb-4">
          ...
          <span className={`px-2 py-1 rounded ${connectionStatus === 'Connected' ? 'bg-green-100 text-green-800' : connectionStatus === 'Error' ? 'bg-red-100 text-red-800' : 'bg-gray-100 text-gray-800'}`}>{connectionStatus}</span>
        </div>
