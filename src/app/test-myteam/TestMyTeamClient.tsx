...
export default function TestMyTeamClient() {
    ...
    <AppLayout>
      <div className="p-6 max-w-7xl mx-auto">
        <div className="mb-6">
          ...
          <p className="text-gray-600">This page demonstrates your MyTeamPanel component integrated into the main application.</p>
          {lastAction && (
            <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
              <p className="text-sm text-blue-700"><strong>Last Action:</strong> {lastAction}</p>
            </div>
          )}
        </div>
