...
export default defineConfig({
  ...
  webServer: {
    command: [
      ...
      '-n web,socket',
      '-c blue,magenta',
      `"NEXT_PUBLIC_FIREBASE_API_KEY= NEXT_PUBLIC_FIREBASE_PROJECT_ID= NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN= NEXT_PUBLIC_FIREBASE_APP_ID= NEXT_PUBLIC_FIREBASE_MESSAGING_SENDER_ID= NEXT_PUBLIC_USE_EMULATORS=false NEXT_PUBLIC_SOCKET_URL=${socketURL} NEXT_PUBLIC_SOCKET_IO_URL=${socketURL} ./node_modules/.bin/next dev --turbopack -p ${port}"`,
