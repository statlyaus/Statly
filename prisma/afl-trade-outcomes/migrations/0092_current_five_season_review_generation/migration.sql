-- Rotate the private historical review identity directly to the final issue #574 capture generation.
-- Scratch capture generations were never released and are not schema authority.
DO $migration$
DECLARE
