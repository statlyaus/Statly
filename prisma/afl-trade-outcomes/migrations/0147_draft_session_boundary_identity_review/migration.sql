-- Admit the player and club identities carried by a reviewed combined-session
-- boundary fact. Preserve every scope, chronology, authority, and evidence
-- validation from the existing identity-review guard.
