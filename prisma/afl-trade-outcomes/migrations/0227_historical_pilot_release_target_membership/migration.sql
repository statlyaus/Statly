-- The retained pilot release can include other transactions. Select the one exact reviewed
-- Cameron version, without changing its immutable release ancestry or admitting other trades.
DO $membership$ BEGIN
