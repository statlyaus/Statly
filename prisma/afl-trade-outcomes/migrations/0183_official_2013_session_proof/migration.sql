-- Bind enumerated 2013 membership/terminal report to the independent 2019 retrospective total.
DO $$
...
BEGIN
 FOREACH signature IN ARRAY ARRAY[
  ...
  old_fragment:=$old$'157359','49872','149290','78408','39972'$old$;
  ...
  definition:=replace(definition,old_fragment,$new$'157359','49872','149290','78408','39972','117263','452467'$new$);
  ...
  new_fragment:=$new$OR (draft.draft_year=2013
                      ...
                      AND substring(terminal_capture.manifest_json->>'sourceUrl'
                                    FROM '^https://www\.afl\.com\.au/news/([0-9]+)(/|$)')='117263')
