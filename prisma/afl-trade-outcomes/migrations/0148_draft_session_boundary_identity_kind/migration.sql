-- Bind each reviewed combined-session boundary identity to its matching entity
-- field. Preserve every scope, chronology, authority, and evidence validation
-- from the existing identity-review guard.
