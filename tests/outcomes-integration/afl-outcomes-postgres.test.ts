...
describe('isolated AFL outcomes PostgreSQL migration', () => {
  ...
  it('records both forward migrations and native authority controls', async () => {
    ...
    expect(migrations.rows.map(({ migration_name }) => migration_name)).toEqual([
      ...
      '0174_rookie_elevation_terminal',
      '0175_reviewed_rookie_correction',
      '0176_partial_date_draft_sessions',
      '0177_reviewed_session_projection',
      '0178_reviewed_session_subset_promotion',
      '0179_reviewed_session_completion_order',
      '0180_reviewed_session_successor',
      '0181_official_2015_session_proof',
      '0182_enumerated_session_inventory',
      '0183_official_2013_session_proof',
      '0184_multi_document_membership',
      '0185_official_2014_session_proof',
      '0186_supplemental_session_selection',
      ...
      '0191_membership_document_identity',
      '0192_official_mini_2011_session_proof',
      '0193_reviewed_session_window_structure',
      '0194_reviewed_session_window_sources',
      '0195_reviewed_window_promotion',
      '0196_window_lifecycle_chronology',
      '0197_reviewed_acquisition_windows',
      ...
      '0202_numbered_union_inventory',
      '0203_official_2010_session_sources',
      '0204_session_identity_observation_scope',
      '0205_reviewed_status_correction',
      ...
      '0210_player_departure_reference_staging',
      '0211_canonical_player_departure',
      ...
      '0216_all_continuity_references',
      '0217_postseason_materialization',
