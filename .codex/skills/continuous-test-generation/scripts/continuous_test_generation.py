#!/usr/bin/env python3
"""
continuous_test_generation.py

Compatibility wrapper that runs vibe-run with the continuous-test-generation workflow.
"""
...
def _sibling_vibe_run() -> Path:
    # .../.codex/skills/continuous-test-generation/scripts/continuous_test_generation.py
...
def main() -> int:
    ap = argparse.ArgumentParser(prog="continuous_test_generation.py")
